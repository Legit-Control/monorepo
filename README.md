...
- `packages/fs/` – Source code of the SDK
- `packages/fs/dist/` – Bundled outputs for Node.js, browser, and TypeScript
- `packages/fs/src/compositeFs/` – Core filesystem abstraction
- `packages/fs/src/compositeFs/subsystems/` – Ephemeral, hidden, pass-through, and Git-backed file systems
